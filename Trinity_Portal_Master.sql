...
(15, @GOSSIP_MENU+5, 4, 6, 67, "幽魂之地"),
(15, @GOSSIP_MENU+5, 5, 6, 469, "洛克莫丹"),
(15, @GOSSIP_MENU+5, 6, 6, 67, "银松森林"),
(15, @GOSSIP_MENU+5, 7, 6, 469, "西部荒野"),
...
(15, @GOSSIP_MENU+6, 4, 6, 469, "血雾岛"),
(15, @GOSSIP_MENU+6, 5, 6, 469, "幽暗海滩"),
(15, @GOSSIP_MENU+6, 6, 6, 67, "贫瘠之地"),
...
(@GOSSIP_MENU, 1, 2, "暴风城", 1, 1, @GOSSIP_MENU, 0, 0, 0, "你确定要前往 暴风城?"),
(@GOSSIP_MENU, 2, 2, "奥格瑞玛", 1, 1, @GOSSIP_MENU, 0, 0, 0, "你确定要前往 奥格瑞玛?"),
(@GOSSIP_MENU, 3, 2, "达纳苏斯", 1, 1, @GOSSIP_MENU, 0, 0, 0, "你确定要前往 达纳苏斯?"),
(@GOSSIP_MENU, 4, 2, "铁炉堡", 1, 1, @GOSSIP_MENU, 0, 0, 0, "你确定要前往 铁炉堡?"),
(@GOSSIP_MENU, 5, 2, "埃索达", 1, 1, @GOSSIP_MENU, 0, 0, 0, "你确定要前往 埃索达?"),
(@GOSSIP_MENU, 6, 2, "雷霆崖", 1, 1, @GOSSIP_MENU, 0, 0, 0, "你确定要前往 雷霆崖?"),
(@GOSSIP_MENU, 7, 2, "幽暗城", 1, 1, @GOSSIP_MENU, 0, 0, 0, "你确定要前往 幽暗城?"),
(@GOSSIP_MENU, 8, 2, "银月城", 1, 1, @GOSSIP_MENU, 0, 0, 0, "你确定要前往 银月城?"),
(@GOSSIP_MENU, 9, 2, "达拉然", 1, 1, @GOSSIP_MENU, 0, 0, 0, "你确定要前往 达拉然?"),
(@GOSSIP_MENU, 10, 2, "沙塔斯城", 1, 1, @GOSSIP_MENU, 0, 0, 0, "你确定要前往 沙塔斯城?"),
(@GOSSIP_MENU, 11, 2, "藏宝海湾", 1, 1, @GOSSIP_MENU, 0, 0, 0, "你确定要前往 藏宝海湾?"),
(@GOSSIP_MENU, 12, 2, "古拉巴什竞技场", 1, 1, @GOSSIP_MENU, 0, 0, 0, "你确定要前往 古拉巴什竞技场?"),
...
(@GOSSIP_MENU, 17, 9, "大陆副本", 1, 1, @GOSSIP_MENU+1, 0, 0, 0, NULL),
(@GOSSIP_MENU, 18, 9, "外域副本", 1, 1, @GOSSIP_MENU+2, 0, 0, 0, NULL),
(@GOSSIP_MENU, 19, 9, "北极副本", 1, 1, @GOSSIP_MENU+3, 0, 0, 0, NULL),
(@GOSSIP_MENU, 20, 9, "团队副本", 1, 1, @GOSSIP_MENU+4, 0, 0, 0, NULL),
(@GOSSIP_MENU+1, 0, 2, "诺莫瑞根", 1, 1, 0, 0, 0, 0, "你确定要前往 诺莫瑞根?"),
(@GOSSIP_MENU+1, 1, 2, "死亡矿井", 1, 1, 0, 0, 0, 0, "你确定要前往 死亡矿井?"),
(@GOSSIP_MENU+1, 2, 2, "暴风城监狱", 1, 1, 0, 0, 0, 0, "你确定要前往 暴风城监狱?"),
(@GOSSIP_MENU+1, 3, 2, "怒焰裂谷", 1, 1, 0, 0, 0, 0, "你确定要前往 怒焰裂谷?"),
(@GOSSIP_MENU+1, 4, 2, "剃刀高地", 1, 1, 0, 0, 0, 0, "你确定要前往 剃刀高地?"),
(@GOSSIP_MENU+1, 5, 2, "剃刀沼泽", 1, 1, 0, 0, 0, 0, "你确定要前往 剃刀沼泽?"),
(@GOSSIP_MENU+1, 6, 2, "血色修道院", 1, 1, 0, 0, 0, 0, "你确定要前往 血色修道院?"),
(@GOSSIP_MENU+1, 7, 2, "影牙城堡", 1, 1, 0, 0, 0, 0, "你确定要前往 影牙城堡?"),
(@GOSSIP_MENU+1, 8, 2, "哀嚎洞穴", 1, 1, 0, 0, 0, 0, "你确定要前往 哀嚎洞穴?"),
(@GOSSIP_MENU+1, 9, 2, "黑暗深渊", 1, 1, 0, 0, 0, 0, "你确定要前往 黑暗深渊?"),
(@GOSSIP_MENU+1, 10, 2, "黑石深渊", 1, 1, 0, 0, 0, 0, "你确定要前往 黑石深渊?"),
(@GOSSIP_MENU+1, 11, 2, "黑石塔", 1, 1, 0, 0, 0, 0, "你确定要前往 黑石塔?"),
(@GOSSIP_MENU+1, 12, 2, "厄运之槌", 1, 1, 0, 0, 0, 0, "你确定要前往 厄运之槌?"),
(@GOSSIP_MENU+1, 13, 2, "玛拉顿", 1, 1, 0, 0, 0, 0, "你确定要前往 玛拉顿?"),
(@GOSSIP_MENU+1, 14, 2, "通灵学院", 1, 1, 0, 0, 0, 0, "你确定要前往 通灵学院?"),
(@GOSSIP_MENU+1, 15, 2, "斯坦索姆", 1, 1, 0, 0, 0, 0, "你确定要前往 斯坦索姆?"),
(@GOSSIP_MENU+1, 16, 2, "沉没的神庙", 1, 1, 0, 0, 0, 0, "你确定要前往 沉没的神庙?"),
(@GOSSIP_MENU+1, 17, 2, "奥达曼", 1, 1, 0, 0, 0, 0, "你确定要前往 奥达曼?"),
(@GOSSIP_MENU+1, 18, 2, "祖尔法拉克", 1, 1, 0, 0, 0, 0, "你确定要前往 Zul'Farrak?"),
(@GOSSIP_MENU+1, 19, 7, "返回..", 1, 1, @GOSSIP_MENU, 0, 0, 0, NULL),
(@GOSSIP_MENU+2, 0, 2, "奥金顿", 1, 1, 0, 0, 0, 0, "你确定要前往 奥金顿?"),
(@GOSSIP_MENU+2, 1, 2, "时光之穴", 1, 1, 0, 0, 0, 0, "你确定要前往 时光之穴?"),
(@GOSSIP_MENU+2, 2, 2, "盘牙洞穴", 1, 1, 0, 0, 0, 0, "你确定要前往 盘牙洞穴?"),
(@GOSSIP_MENU+2, 3, 2, "地狱火堡垒", 1, 1, 0, 0, 0, 0, "你确定要前往 地狱火堡垒?"),
(@GOSSIP_MENU+2, 4, 2, "魔导师平台", 1, 1, 0, 0, 0, 0, "你确定要前往 魔导师平台?"),
(@GOSSIP_MENU+2, 5, 2, "Tempest Keep", 1, 1, 0, 0, 0, 0, "你确定要前往 风暴要塞?"),
(@GOSSIP_MENU+2, 6, 7, "返回..", 1, 1, @GOSSIP_MENU, 0, 0, 0, NULL),
(@GOSSIP_MENU+3, 0, 2, "埃兹卓", 1, 1, 0, 0, 0, 0, "你确定要前往 埃兹卓?"),
(@GOSSIP_MENU+3, 1, 2, "旧斯坦索姆", 1, 1, 0, 0, 0, 0, "你确定要前往 旧斯坦索姆?"),
(@GOSSIP_MENU+3, 2, 2, "勇士的试炼", 1, 1, 0, 0, 0, 0, "你确定要前往 勇士的试炼?"),
(@GOSSIP_MENU+3, 3, 2, "达克萨隆要塞", 1, 1, 0, 0, 0, 0, "你确定要前往 达克萨隆要塞?"),
(@GOSSIP_MENU+3, 4, 2, "古达克", 1, 1, 0, 0, 0, 0, "你确定要前往 古达克?"),
(@GOSSIP_MENU+3, 5, 2, "冰冠城塞", 1, 1, 0, 0, 0, 0, "你确定要前往 冰冠城塞?"),
(@GOSSIP_MENU+3, 6, 2, "魔枢", 1, 1, 0, 0, 0, 0, "你确定要前往 魔枢?"),
(@GOSSIP_MENU+3, 7, 2, "紫罗兰监狱", 1, 1, 0, 0, 0, 0, "你确定要前往 紫罗兰监狱?"),
(@GOSSIP_MENU+3, 8, 2, "闪电大厅", 1, 1, 0, 0, 0, 0, "你确定要前往 闪电大厅?"),
(@GOSSIP_MENU+3, 9, 2, "石头大厅", 1, 1, 0, 0, 0, 0, "你确定要前往 石头大厅?"),
(@GOSSIP_MENU+3, 10, 2, "乌特加德要塞", 1, 1, 0, 0, 0, 0, "你确定要前往 乌特加德要塞?"),
(@GOSSIP_MENU+3, 11, 2, "乌特加德之巅", 1, 1, 0, 0, 0, 0, "你确定要前往 乌特加德之巅?"),
(@GOSSIP_MENU+3, 12, 7, "返回..", 1, 1, @GOSSIP_MENU, 0, 0, 0, NULL),
(@GOSSIP_MENU+4, 0, 2, "黑暗神庙", 1, 1, 0, 0, 0, 0, "你确定要前往 黑暗神庙?"),
(@GOSSIP_MENU+4, 1, 2, "黑翼之巢", 1, 1, 0, 0, 0, 0, "你确定要前往 黑翼之巢?"),
(@GOSSIP_MENU+4, 2, 2, "海加尔山", 1, 1, 0, 0, 0, 0, "你确定要前往 海加尔山?"),
(@GOSSIP_MENU+4, 3, 2, "毒蛇神殿", 1, 1, 0, 0, 0, 0, "你确定要前往 毒蛇神殿?"),
(@GOSSIP_MENU+4, 4, 2, "十字军试炼", 1, 1, 0, 0, 0, 0, "你确定要前往 十字军试炼?"),
(@GOSSIP_MENU+4, 5, 2, "戈鲁尔之巢", 1, 1, 0, 0, 0, 0, "你确定要前往 戈鲁尔之巢?"),
(@GOSSIP_MENU+4, 6, 2, "玛瑟里顿的巢穴", 1, 1, 0, 0, 0, 0, "你确定要前往 玛瑟里顿的巢穴?"),
(@GOSSIP_MENU+4, 7, 2, "冰冠城塞", 1, 1, 0, 0, 0, 0, "你确定要前往 冰冠城塞?"),
(@GOSSIP_MENU+4, 8, 2, "卡拉赞", 1, 1, 0, 0, 0, 0, "你确定要前往 卡拉赞?"),
(@GOSSIP_MENU+4, 9, 2, "熔火之心", 1, 1, 0, 0, 0, 0, "你确定要前往 熔火之心?"),
(@GOSSIP_MENU+4, 10, 2, "纳克萨玛斯", 1, 1, 0, 0, 0, 0, "你确定要前往 纳克萨玛斯?"),
(@GOSSIP_MENU+4, 11, 2, "奥妮克希亚的巢穴", 1, 1, 0, 0, 0, 0, "你确定要前往 奥妮克希亚的巢穴?"),
(@GOSSIP_MENU+4, 12, 2, "安其拉废墟", 1, 1, 0, 0, 0, 0, "你确定要前往 安其拉废墟?"),
(@GOSSIP_MENU+4, 13, 2, "太阳井高地", 1, 1, 0, 0, 0, 0, "你确定要前往 太阳井高地?"),
(@GOSSIP_MENU+4, 14, 2, "风暴之眼", 1, 1, 0, 0, 0, 0, "你确定要前往 风暴之眼?"),
(@GOSSIP_MENU+4, 15, 2, "安其拉神庙", 1, 1, 0, 0, 0, 0, "你确定要前往 安其拉神庙?"),
(@GOSSIP_MENU+4, 16, 2, "永恒之眼", 1, 1, 0, 0, 0, 0, "你确定要前往 永恒之眼?"),
(@GOSSIP_MENU+4, 17, 2, "黑曜石圣殿", 1, 1, 0, 0, 0, 0, "你确定要前往 黑曜石圣殿?"),
(@GOSSIP_MENU+4, 18, 2, "奥杜尔", 1, 1, 0, 0, 0, 0, "你确定要前往 奥杜尔?"),
(@GOSSIP_MENU+4, 19, 2, "阿尔卡冯的宝库", 1, 1, 0, 0, 0, 0, "你确定要前往 阿尔卡冯的宝库?"),
(@GOSSIP_MENU+4, 21, 2, "祖尔格拉布", 1, 1, 0, 0, 0, 0, "你确定要前往 祖尔格拉布?"),
(@GOSSIP_MENU+4, 22, 2, "祖阿曼", 1, 1, 0, 0, 0, 0, "你确定要前往 祖阿曼?"),
(@GOSSIP_MENU+4, 23, 7, "返回..", 1, 1, @GOSSIP_MENU, 0, 0, 0, NULL),
(@GOSSIP_MENU+5, 0, 2, "艾尔文森林", 1, 1, 0, 0, 0, 0, "你确定要前往 艾尔文森林?"),
(@GOSSIP_MENU+5, 1, 2, "永歌森林", 1, 1, 0, 0, 0, 0, "你确定要前往 永歌森林?"),
(@GOSSIP_MENU+5, 2, 2, "丹莫罗", 1, 1, 0, 0, 0, 0, "你确定要前往 丹莫罗?"),
(@GOSSIP_MENU+5, 3, 2, "提瑞斯法林地", 1, 1, 0, 0, 0, 0, "你确定要前往 提瑞斯法林地?"),
(@GOSSIP_MENU+5, 4, 2, "幽魂之地", 1, 1, 0, 0, 0, 0, "你确定要前往 幽魂之地?"),
(@GOSSIP_MENU+5, 5, 2, "洛克莫丹", 1, 1, 0, 0, 0, 0, "你确定要前往 洛克莫丹?"),
(@GOSSIP_MENU+5, 6, 2, "银松森林", 1, 1, 0, 0, 0, 0, "你确定要前往 银松森林?"),
(@GOSSIP_MENU+5, 7, 2, "西部荒野", 1, 1, 0, 0, 0, 0, "你确定要前往 西部荒野?"),
(@GOSSIP_MENU+5, 8, 2, "赤脊山", 1, 1, 0, 0, 0, 0, "你确定要前往 赤脊山?"),
(@GOSSIP_MENU+5, 9, 2, "暮色森林", 1, 1, 0, 0, 0, 0, "你确定要前往 暮色森林?"),
(@GOSSIP_MENU+5, 10, 2, "希尔斯布莱德丘陵", 1, 1, 0, 0, 0, 0, "你确定要前往 希尔斯布莱德丘陵?"),
(@GOSSIP_MENU+5, 11, 2, "湿地", 1, 1, 0, 0, 0, 0, "你确定要前往 湿地?"),
(@GOSSIP_MENU+5, 12, 2, "奥特兰克山脉", 1, 1, 0, 0, 0, 0, "你确定要前往 奥特兰克山脉?"),
(@GOSSIP_MENU+5, 13, 2, "阿拉希高地", 1, 1, 0, 0, 0, 0, "你确定要前往 阿拉希高地?"),
(@GOSSIP_MENU+5, 14, 2, "荆棘谷", 1, 1, 0, 0, 0, 0, "你确定要前往 荆棘谷?"),
(@GOSSIP_MENU+5, 15, 2, "荒芜之地", 1, 1, 0, 0, 0, 0, "你确定要前往 荒芜之地?"),
(@GOSSIP_MENU+5, 16, 2, "悲伤沼泽", 1, 1, 0, 0, 0, 0, "你确定要前往 悲伤沼泽?"),
(@GOSSIP_MENU+5, 17, 2, "辛特兰", 1, 1, 0, 0, 0, 0, "你确定要前往 辛特兰?"),
(@GOSSIP_MENU+5, 18, 2, "灼热峡谷", 1, 1, 0, 0, 0, 0, "你确定要前往 灼热峡谷?"),
(@GOSSIP_MENU+5, 19, 2, "诅咒之地", 1, 1, 0, 0, 0, 0, "你确定要前往 诅咒之地?"),
(@GOSSIP_MENU+5, 20, 2, "燃烧平原", 1, 1, 0, 0, 0, 0, "你确定要前往 燃烧平原?"),
(@GOSSIP_MENU+5, 21, 2, "西瘟疫之地", 1, 1, 0, 0, 0, 0, "你确定要前往 西瘟疫之地?"),
(@GOSSIP_MENU+5, 22, 2, "东瘟疫之地", 1, 1, 0, 0, 0, 0, "你确定要前往 东瘟疫之地?"),
(@GOSSIP_MENU+5, 23, 2, "奎尔丹纳斯岛", 1, 1, 0, 0, 0, 0, "你确定要前往 奎尔丹纳斯岛?"),
(@GOSSIP_MENU+5, 24, 7, "返回..", 1, 1, @GOSSIP_MENU, 0, 0, 0, NULL),
(@GOSSIP_MENU+6, 0, 2, "秘蓝岛", 1, 1, 0, 0, 0, 0, "你确定要前往 秘蓝岛?"),
(@GOSSIP_MENU+6, 1, 2, "泰达希尔", 1, 1, 0, 0, 0, 0, "你确定要前往 泰达希尔?"),
(@GOSSIP_MENU+6, 2, 2, "杜隆塔尔", 1, 1, 0, 0, 0, 0, "你确定要前往 杜隆塔尔?"),
(@GOSSIP_MENU+6, 3, 2, "莫高雷", 1, 1, 0, 0, 0, 0, "你确定要前往 莫高雷?"),
(@GOSSIP_MENU+6, 4, 2, "血雾岛", 1, 1, 0, 0, 0, 0, "你确定要前往 血雾岛?"),
(@GOSSIP_MENU+6, 5, 2, "黑海岸", 1, 1, 0, 0, 0, 0, "你确定要前往 黑海岸?"),
(@GOSSIP_MENU+6, 6, 2, "贫瘠之地", 1, 1, 0, 0, 0, 0, "你确定要前往 贫瘠之地?"),
(@GOSSIP_MENU+6, 7, 2, "石爪山脉", 1, 1, 0, 0, 0, 0, "你确定要前往 石爪山脉?"),
(@GOSSIP_MENU+6, 8, 2, "灰谷森林", 1, 1, 0, 0, 0, 0, "你确定要前往 灰谷森林?"),
(@GOSSIP_MENU+6, 9, 2, "千针石林", 1, 1, 0, 0, 0, 0, "你确定要前往 千针石林?"),
(@GOSSIP_MENU+6, 10, 2, "凄凉之地", 1, 1, 0, 0, 0, 0, "你确定要前往 凄凉之地?"),
(@GOSSIP_MENU+6, 11, 2, "尘泥沼泽", 1, 1, 0, 0, 0, 0, "你确定要前往 尘泥沼泽?"),
(@GOSSIP_MENU+6, 12, 2, "菲拉斯", 1, 1, 0, 0, 0, 0, "你确定要前往 菲拉斯?"),
(@GOSSIP_MENU+6, 13, 2, "塔纳利斯", 1, 1, 0, 0, 0, 0, "你确定要前往 塔纳利斯?"),
(@GOSSIP_MENU+6, 14, 2, "艾萨拉", 1, 1, 0, 0, 0, 0, "你确定要前往 艾萨拉?"),
(@GOSSIP_MENU+6, 15, 2, "费伍德", 1, 1, 0, 0, 0, 0, "你确定要前往 费伍德?"),
(@GOSSIP_MENU+6, 16, 2, "安戈洛环形山", 1, 1, 0, 0, 0, 0, "你确定要前往 安戈洛环形山?"),
(@GOSSIP_MENU+6, 17, 2, "希利苏斯", 1, 1, 0, 0, 0, 0, "你确定要前往 希利苏斯?"),
(@GOSSIP_MENU+6, 18, 2, "冬泉谷", 1, 1, 0, 0, 0, 0, "你确定要前往 冬泉谷?"),
(@GOSSIP_MENU+6, 19, 7, "返回..", 1, 1, @GOSSIP_MENU, 0, 0, 0, NULL),
(@GOSSIP_MENU+7, 0, 2, "地狱火半岛", 1, 1, 0, 0, 0, 0, "你确定要前往 地狱火半岛?"),
(@GOSSIP_MENU+7, 1, 2, "赞加沼泽", 1, 1, 0, 0, 0, 0, "你确定要前往 赞加沼泽?"),
(@GOSSIP_MENU+7, 2, 2, "泰罗卡森林", 1, 1, 0, 0, 0, 0, "你确定要前往 泰罗卡森林?"),
(@GOSSIP_MENU+7, 3, 2, "纳格兰", 1, 1, 0, 0, 0, 0, "你确定要前往 纳格兰?"),
(@GOSSIP_MENU+7, 4, 2, "刀锋山", 1, 1, 0, 0, 0, 0, "你确定要前往 刀锋山?"),
(@GOSSIP_MENU+7, 5, 2, "虚空风暴", 1, 1, 0, 0, 0, 0, "你确定要前往 虚空风暴?"),
(@GOSSIP_MENU+7, 6, 2, "影月谷", 1, 1, 0, 0, 0, 0, "你确定要前往 影月谷?"),
(@GOSSIP_MENU+7, 7, 7, "返回..", 1, 1, @GOSSIP_MENU, 0, 0, 0, NULL),
(@GOSSIP_MENU+8, 0, 2, "北风苔原", 1, 1, 0, 0, 0, 0, "你确定要前往 北风苔原?"),
(@GOSSIP_MENU+8, 1, 2, "尖啸海湾", 1, 1, 0, 0, 0, 0, "你确定要前往 尖啸海湾?"),
(@GOSSIP_MENU+8, 2, 2, "龙骨荒野", 1, 1, 0, 0, 0, 0, "你确定要前往 龙骨荒野?"),
(@GOSSIP_MENU+8, 3, 2, "灰熊丘陵", 1, 1, 0, 0, 0, 0, "你确定要前往 灰熊丘陵?"),
(@GOSSIP_MENU+8, 4, 2, "祖达克", 1, 1, 0, 0, 0, 0, "你确定要前往 祖达克?"),
(@GOSSIP_MENU+8, 5, 2, "索拉扎盆地", 1, 1, 0, 0, 0, 0, "你确定要前往 索拉扎盆地?"),
(@GOSSIP_MENU+8, 6, 2, "晶歌森林", 1, 1, 0, 0, 0, 0, "你确定要前往 晶歌森林?"),
(@GOSSIP_MENU+8, 7, 2, "风暴峭壁", 1, 1, 0, 0, 0, 0, "你确定要前往 风暴峭壁?"),
(@GOSSIP_MENU+8, 8, 2, "冰冠城塞", 1, 1, 0, 0, 0, 0, "你确定要前往 冰冠城塞?"),
(@GOSSIP_MENU+8, 9, 2, "冬拥湖", 1, 1, 0, 0, 0, 0, "你确定要前往 冬拥湖?"),
